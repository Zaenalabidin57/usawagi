...
ALLOWED_HOSTS = ['usawagi.vercel.app', '.vercel.app', 'localhost', '127.0.0.1']
...
# Media files - use external media server
MEDIA_URL = os.environ.get('MEDIA_SERVER_URL', 'http://202.10.40.32:8080/media/') + '/'
...
# Security settings - disabled for Vercel preview
...
MEDIA_SERVER_URL = os.environ.get('MEDIA_SERVER_URL', 'http://202.10.40.32:8080')
MEDIA_SERVER_API_KEY = os.environ.get('MEDIA_SERVER_API_KEY', '')

# Log configuration settings
logger.info(f"ALLOWED_HOSTS: {ALLOWED_HOSTS}")
logger.info(f"MEDIA_SERVER_URL: {MEDIA_SERVER_URL}")
